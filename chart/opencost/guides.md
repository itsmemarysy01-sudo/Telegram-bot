...
```console
helm install my-opencost oci://dhi.io/opencost-chart --version <version> \
...
pod/my-opencost-7d9f8b6c4-xk2pq              1/1     Running   0          30s

NAME                                          TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)    AGE
service/my-opencost                           ClusterIP   10.43.101.42   <none>        9003/TCP   30s

NAME                                          READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/my-opencost                   1/1     1            1           30s

NAME                                                   DESIRED   CURRENT   READY   AGE
replicaset.apps/my-opencost-7d9f8b6c4                  1         1         1       30s
```
