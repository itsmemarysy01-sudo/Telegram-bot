...
- Kubernetes 1.16+ (recommended 1.30+)
...
> **Note:** This chart requires an external PostgreSQL database. Unlike the upstream chart, the PostgreSQL subchart is
> not supported and postgreSQL must be provisioned separately before installing.

```console
helm install my-kyverno-reports-server oci://dhi.io/kyverno-reports-server-chart --version <version> \
...
pod/my-kyverno-reports-server-chart-6c6f7c4877-28qhz   1/1     Running   0          72s

NAME                                        TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)   AGE
service/my-kyverno-reports-server-chart   ClusterIP   10.43.33.254   <none>        443/TCP   72s

NAME                                                READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/my-kyverno-reports-server-chart   1/1     1            1           72s

NAME                                                           DESIRED   CURRENT   READY   AGE
replicaset.apps/my-kyverno-reports-server-chart-6c6f7c4877   1         1         1       72s
```
