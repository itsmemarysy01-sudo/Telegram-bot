...
if [[ $ENABLE_OTEL == true ]]; then
  OTEL_AGENT="-javaagent:/usr/share/datahub-gms/lib/opentelemetry-javaagent.jar "
fi

PROMETHEUS_AGENT=""
if [[ $ENABLE_PROMETHEUS == true ]]; then
  PROMETHEUS_AGENT="-javaagent:/usr/share/datahub-gms/lib/jmx_prometheus_javaagent.jar=4318:/usr/share/datahub-gms/scripts/prometheus-config.yaml "
fi
...
COMMON="
    ...
    $PROMETHEUS_AGENT \
    -Dstats=unsecure \
    -jar /usr/share/datahub-gms/bin/war.war"
