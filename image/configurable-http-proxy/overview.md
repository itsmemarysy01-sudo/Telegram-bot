...
Configurable HTTP Proxy is a Node.js reverse proxy with a REST API for dynamic routing. It is widely used with
[JupyterHub](https://jupyterhub.readthedocs.io/) to manage proxy routes without restarting the proxy process. The
upstream project publishes releases and documentation on
[GitHub](https://github.com/jupyterhub/configurable-http-proxy).
