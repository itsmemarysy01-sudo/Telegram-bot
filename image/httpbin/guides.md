...
## Common httpbin use cases

### Inspect an outgoing request
...
### Use httpbin as a test dependency in Compose

Run httpbin alongside an application under test so integration tests can exercise real HTTP behavior (delays, redirects,
encoded responses) without depending on an external service.
