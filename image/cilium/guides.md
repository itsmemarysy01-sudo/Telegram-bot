...
```
$ docker run --rm -it dhi.io/cilium:<tag>
```

### Install Cilium using Helm

You can install Cilium using the official helm chart and replace the cilium-ci image. Replace `<your-registry-secret>`
...
helm upgrade --install cilium cilium/cilium \
  -n cilium --create-namespace --wait \
  --set "imagePullSecrets[0].name=<your-registry-secret>" \
  --set image.repository=dhi.io/cilium \
  --set image.tag=<tag>
```
